      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        {targets.map(target => (
          <div 
            ...
            className={`glass-card p-6 rounded-xl text-center cursor-pointer transition-all hover:shadow-md hover:-translate-y-1 ${
              selectedTarget === target.id ? 'ring-2 ring-primary' : ''
            }`}
          >
